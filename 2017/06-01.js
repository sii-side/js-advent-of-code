...
class Memory {
  ...
  reallocate () {
    ...
    const isIncludeHistory = this.history.includes(this.banks)
...
class History {
  ...
  includes (banks) {
    ...
    return this.all.some(history => JSON.stringify(history) === JSON.stringify(numbers))
  }
}
